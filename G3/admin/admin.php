    ...
    <div class="card shadow-lg">
        ...
        <div class="card-body">
            ...
            <form method="GET" class="row g-3 mb-4">
                ...
                <div class="col-md-2">
                    <a href="admin/admin.php" class="btn btn-secondary w-100">Reset</a>
                </div>
            </form>
            <div class="mb-3">
                <a href="admin/create.php" class="btn btn-success">+ Add New Product</a>
            </div>
            <!-- Student Table -->
                        ...
                        while($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    <td>
                                        ...
                                        <a href='admin/delete.php?id=".$row["id"]."' class='btn btn-sm btn-danger' onclick=\"return confirm('Are you sure you want to delete this student?');\">Delete</a>
                                    </td>
                                  </tr>";
                        }
                    } else {
